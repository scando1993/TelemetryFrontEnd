        ...
        <div class="box-content">
          <div class="btn-toolbar pull-right clearfix">
            <div class="btn-group">
              ...
              <router-link class="pageLink" to="/createWifiScan">
                <a class="btn btn-circle show-tooltip" title="Add new " href="/createWifiScan">
              ...
              <router-link class="pageLink" to="/wifiScan">
                <a class="btn btn-circle show-tooltip" title="Refresh" id="refresh-administrators" href="/wifiScan">
              ...
              <div class="dataTables_wrapper form-inline dt-bootstrap" id="example1_wrapper">
                ...
                <div class="row">
                  <div class="col-sm-12 table-responsive">
                      <table aria-describedby="Table_of_elements" role="grid" id="table_wifiScan" class="table table-bordered table-striped dataTable">
                        <thead>
                          <tr role="row">
                            ...
                            <th aria-label="Nombre: activate to sort column ascending" style="width: 207px;" colspan="1" rowspan="1" aria-controls="example1" tabindex="0" class="sorting">MAC</th>
                            <th aria-label="Nombre: activate to sort column ascending" style="width: 207px;" colspan="1" rowspan="1" aria-controls="example1" tabindex="0" class="sorting">RSSI</th>
                            <th></th>
                          </tr>
                        </thead>
                        <tbody id="fields">
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <th colspan="1" rowspan="1">RSSI</th>
                        <th></th>
                      </tr>
                    </tfoot>
                    </table>
...
<script>
  ...
  export default {
    ...
    mounted() {
      this.$nextTick(() => {
        $('#table_wifiScan').DataTable()
      })
    },
    methods: {
      deleteOne: function () {
        console.log(this.id + '--' + this.MAC)
      }
    }
  }
</script>
