                  ...
                  <div class="col-sm-12 table-responsive">
                      <table aria-describedby="Table_of_elements" role="grid" id="table_store" class="table table-bordered table-striped dataTable">
                        <thead>
                          <tr role="row">
                            ...
                            <th aria-label="Nombre: activate to sort column ascending" style="width: 207px;" colspan="1" rowspan="1" aria-controls="example1" tabindex="0" class="sorting">Temperature</th>
                            <th aria-label="Nombre: activate to sort column ascending" style="width: 207px;" colspan="1" rowspan="1" aria-controls="example1" tabindex="0" class="sorting">Location</th>
                            <th></th>
                          </tr>
                        </thead>
                        <tbody id="fields">
                    ...
                    <tfoot>
                      <tr>
                        ...
                        <th colspan="1" rowspan="1">Temperature</th>
