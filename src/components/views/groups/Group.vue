        ...
        <div class="box-content">
          <div class="btn-toolbar pull-right clearfix">
            <div class="btn-group">
              ...
              <router-link class="pageLink" to="/createGroup">
                <a class="btn btn-circle show-tooltip" title="Añadir nueva zona" href="/createGroup">
                  <i class="fa fa-plus"></i>
                </a>
              </router-link>
              <router-link class="pageLink" to="/groups">
                <a class="btn btn-circle show-tooltip" v-on:click='refresh' title="Actualizar" id="refreshed" href="/groups">
              ...
              <div class="dataTables_wrapper form-inline dt-bootstrap" id="example1_wrapper">
                ...
                <div class="row">
                  <div class="col-sm-12 table-responsive">
                    <table aria-describedby="Table_of_groups" role="grid" id="table_group"  class="table table-bordered table-striped dataTable">
                      <thead>
                        <tr role="row">
                      ...
                      <tbody id="fields" v-if="full">
                        <tr class="even" role="row" v-for="dato, index in group.dataGet[0].groups">
...
<script>
  ...
  export default {
    ...
    name: 'Group',
    mounted() {
      api.getAll(this.apiBack, this.group)
      setTimeout(e => {
        if (this.group.dataGet[0].groups.length !== 0) { this.full = true }
        this.$nextTick(() => {
    ...
    methods: {
      ...
      async deleteOne(key) {
        var elementDeleted = this.group.dataGet[0].groups.splice(key, 1)
        var id = elementDeleted[0].id
        api.delete(this.apiBack + '/' + id, this.$data)
      },
      exportExcel() {
        // var rep = this.dataGet
        var rep = JSON.parse(JSON.stringify(this.group.dataGet[0].groups))
